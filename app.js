...
session.send('notbad, herewego, teachme, bitch plz, ifyouknow, no no, gaay, wow, okay, pepe');
  }
...
//pokemon start ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++  
   ...
   else if(session.message.text.toLowerCase().contains('pokedex ')){
    ...
    if(session.message.text.toLowerCase().contains('uranguru')){
       ...
       session.send('*Description:* Oranguru live solitary lives deep in the forests and do not usually take much action. Instead, they position themselves high up in the trees to meditate. Long ago, people thought that Oranguru were humans who dwelled in the forest depths, so they called them the people of the forests. Oranguru is kind to the other Pokémon living in the forest, providing medicine for injured Pokémon and food for the hungry. ');
