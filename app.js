...
//meme start ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    
  ...
  if(session.message.text.toLowerCase().contains('notbad')){
   ...
   session.send({attachments: [{contenttype: 'image/jpg', contenturl: 'https://www.google.com.ph/search?q=meme+no&rlz=1C1GGRV_enPH751PH751&tbm=isch&imgil=LCfufUX39GxywM%253A%253BSmwCZVssst6g-M%253Bhttp%25253A%25252F%25252Fweknowmemes.com%25252F2012%25252F03%25252Fno-rage-face-meme%25252F&source=iu&pf=m&fir=LCfufUX39GxywM%253A%252CSmwCZVssst6g-M%252C_&usg=__XmgXxivhxYMs55hqQ5kEFONXWB0%3D'}]});'}]});
}
